...
class ContactoRepartidorController extends Controller
{
    public function index(){
        return view('pages.contactorepartidor.index');
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('contactorepartidor.index')->with('info','Tu correo fué enviado exitosamente.');//Se le pasa un mensaje de envio a la vista contacto.index
