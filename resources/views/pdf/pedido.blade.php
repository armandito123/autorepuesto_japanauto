                ...
                <table id="facarticulo" style="border: solid 1px rgb(206, 190, 190)">
                    ...
                    @foreach($detalle as $det)
                        <tr>
                            <td>{{$det->cantidad}}</td>
                            <td>{{$det->medida}}</td>
                            <td>{{repuesto($det->idRepuesto)->descripcion}}</td>
                            <td>{{repuesto($det->idRepuesto)->precioVenta}}</td>
                            <td>{{operaciones($det->cantidad,repuesto($det->idRepuesto)->precioVenta,'*')}} .Bs</td>
                        </tr>
                    @endforeach
                    </tbody>
                    <tfoot>
