    ...
    <div class="container-contactanos">
        <div style="width: 1000px; margin-left: 10px; " class="row">
            ...
            <!--FORMULARIO PARA ENVIO DE CORREOS-->
                <form action="{{ route('contactoadministrador.store') }}" method="POST" class="px-8 py-8 form-contacto">
                    @csrf  <!--TOKEN-->
                    ...
                    <div class="mb-3"><!--CORREO DESTINATARIO-->
                        ...
                        <select class="form-control form-control select2" id="correo_destino" name="correo_destino" style="width: 100%;">
                            @foreach (@usuarios() as $usu)<!--Arreglo muestra todos los correos de usuarios registrados-->
